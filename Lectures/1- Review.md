...
Example:
    ...
    // Overloaded version (different parameter type)
...
Problem:
    ...
    System.out.println(s1.equals((Object)s2)); // false !!!
    ``` 
Why?
Because equals(Object) was not overridden — Java still calls the default Object.equals() in polymorphic contexts. This breaks expected behavior in collections like ArrayList, HashSet, etc.
3. Overriding equals() (Correct Approach)
```java
class Student {
    private int id;
...
System.out.println(s1.equals(s2)); // true
```
Correct logical equality is achieved.
4. Key Differences Summary
| Aspect                  | Overloading equals(Student) | Overriding equals(Object)  |
| ---------------         | --------------------------- |----------------------------|
| Method Signature        | equals(Student other)       |  equals(Object obj)        |
| Replaces Object.equals? | No                          |   Yes                      |
